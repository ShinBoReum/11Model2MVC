...
$(function(){
	...
	$(".ct_btn01:contains('수정')").on("click",function(){
		$("form").attr("method" , "POST").attr("action" , "/purchase/updatePurchase?tranNo=${purchase.tranNo}&menu=${role}").submit();
	});
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="1" ${fn:trim(purchase.paymentOption)=='1'?"selected" : ""}>현금구매</option>
				<option value="2" ${fn:trim(purchase.paymentOption)=='2'? "selected" : ""}>카드구매</option>
			</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="104" class="ct_write">받는이이름</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
	...
	<tr>
		<td width="104" class="ct_write">받는이 연락처</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
	...
	<tr>
		<td width="104" class="ct_write">받는이주소</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
